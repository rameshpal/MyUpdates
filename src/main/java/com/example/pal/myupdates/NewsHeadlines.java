...
public class NewsHeadlines extends AppCompatActivity {
    ...
    protected void Initialization() {
        _rv_gadgetHeading = (RecyclerView) findViewById(R.id.rv_act_newsheadlines_headlines);
    ...
    public class gata extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog=new ProgressDialog(NewsHeadlines.this);
    ...
    public static class RequestBuilder {
        ...
        public static HttpUrl buildURL() {
            return new HttpUrl.Builder()
                    ...
                    .addQueryParameter("source", "metro") //add query parameters to the URL
