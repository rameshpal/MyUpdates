...
public class MusicHeadlines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_headlines);
    ...
    protected void Initialization() {
        _rv_gadgetHeading = (RecyclerView) findViewById(R.id.rv_act_musicheadlines_headlines);
    ...
    public class gata extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog=new ProgressDialog(MusicHeadlines.this);
...
//                .add("logintoken", token)
        ...
        public static HttpUrl buildURL() {
            return new HttpUrl.Builder()
                    ...
                    .addQueryParameter("source", "mtv-news") //add query parameters to the URL
